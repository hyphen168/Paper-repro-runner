...
body {
    background:
        radial-gradient(1200px 700px at 10% -8%, rgba(0, 240, 255, 0.10), transparent 60%),
        radial-gradient(1000px 620px at 90% 4%, rgba(255, 42, 109, 0.08), transparent 58%),
        radial-gradient(900px 700px at 55% 112%, rgba(255, 206, 0, 0.05), transparent 60%),
        radial-gradient(1000px 600px at 8% 108%, rgba(122, 47, 247, 0.10), transparent 62%),
        linear-gradient(160deg, #070a12 0%, #0a1020 46%, #0c0918 100%);
...
h1 { color: var(--text-strong); text-shadow: 0 0 2px rgba(0, 240, 255, 0.7), 0 0 22px rgba(0, 240, 255, 0.18); letter-spacing: 0.02em; }
...
.panel {
    ...
    background: linear-gradient(180deg, rgba(255, 255, 255, 0.045), transparent 34%), var(--bg-glass);
...
.floating-card {
    border-radius: var(--radius-lg);
    background: linear-gradient(180deg, rgba(255, 255, 255, 0.04), transparent 32%), var(--bg-glass);
    border: 1px solid var(--stroke);
    -webkit-backdrop-filter: var(--glass-blur-weak);
    backdrop-filter: var(--glass-blur-weak);
